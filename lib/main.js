...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const postFailureScripts = !postFailureScriptInput ? undefined : (0, script_parser_1.parseScript)(postFailureScriptInput);
            console.log(`Post failure script:`);
            postFailureScripts === null || postFailureScripts === void 0 ? void 0 : postFailureScripts.forEach((script) => __awaiter(this, void 0, void 0, function* () {
                console.log(`${script}`);
            }));
                ...
                if (postFailureScripts !== undefined) {
                    ...
                    try {
                        for (const postFailureScript of postFailureScripts) {
                            ...
                            yield exec.exec('sh', ['-c', postFailureScript]);
                        }
                    }
                    catch (error) {
                    }
