...
class UnusedVarsVisitor extends Visitor_1.Visitor {
    ...
    constructor(context) {
        ...
        __classPrivateFieldSet(this, _UnusedVarsVisitor_scopeManager, (0, nullThrows_1.nullThrows)(context.getSourceCode().scopeManager, 'Missing required scope manager'), "f");
    }
...
function isUsedVariable(variable) {
    ...
    function getRhsNode(ref, prevRhsNode) {
        ...
        function isInLoop(node) {
            ...
            while (currentNode) {
                if (experimental_utils_1.ASTUtils.isFunction(currentNode)) {
                    break;
                }
                if (experimental_utils_1.ASTUtils.isLoop(currentNode)) {
                    return true;
                }
