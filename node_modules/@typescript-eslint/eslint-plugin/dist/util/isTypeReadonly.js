...
function isTypeReadonlyArrayOrTuple(checker, type, options, seenTypes) {
    ...
    if (checker.isArrayType(type)) {
        const symbol = (0, nullThrows_1.nullThrows)(type.getSymbol(), nullThrows_1.NullThrowsReasons.MissingToken('symbol', 'array type'));
...
function isTypeReadonlyObject(checker, type, options, seenTypes) {
    ...
    if (properties.length) {
        ...
        for (const property of properties) {
            const propertyType = (0, nullThrows_1.nullThrows)((0, propertyTypes_1.getTypeOfPropertyOfType)(checker, type, property), nullThrows_1.NullThrowsReasons.MissingToken(`property "${property.name}"`, 'type'));
